    ...
    <body>
            <div class="container mt-5">
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos Capacitaciones</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="modo" placeholder="Modalidad">
                        ...
                        <div class="col-md-8">
                            <table class="table" >
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['idCapacitacion']?></th>
                                                <th><?php  echo $row['nombre']?></th>
                                                <th><?php  echo $row['apellido']?></th>
                                                <th><?php  echo $row['capacitacion']?></th>
                                                <th><?php  echo $row['correo']?></th>    
                                                <th><?php  echo $row['modo']?></th>
                                                <th><?php  echo $row['fecha']?></th>    
                                                <th><a href="actualizar.php?id=<?php echo $row['idCapacitacion'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete.php?id=<?php echo $row['idCapacitacion'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
