...
$sql="SELECT * FROM problemas WHERE idProblema='$id'";
    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="hidden" class="form-control mb-3" name="idProblema" value="<?php echo $row['idProblema']  ?>">
                                ...
                                <input type="text" class="form-control mb-3" name="personal" placeholder="Personal/Area" value="<?php echo $row['personal']  ?>">
